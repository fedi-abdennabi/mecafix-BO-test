...
$app->routeMiddleware([
    ...
    'isPageValid' => App\Http\Middleware\ValidatePageToken::class,
    'checkResourceOwner' => \App\Http\Middleware\CheckResourceOwner::class,
...
// $app->useStoragePath( env( 'APP_STORAGE'), base_path() . '/public/storage');
return $app;
